...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<UserProfile> _allProfiles = [
    UserProfile(
      ...
      assetPath: "images/pics1.jpg",
    ),
    UserProfile(
      name: "Lexa",
      age: 19,
      major: "Information Technology",
      assetPath: "images/pics2.jpg",
    ),
    UserProfile(
      name: "Silvia",
      age: 19,
      major: "Business",
      assetPath: "images/pics3.jpg",
    ),
    UserProfile(
      name: "Alice",
      age: 20,
      major: "Multimedia",
      assetPath: "images/pics4.jpg",
    ),
    UserProfile(
      name: "Sarah",
      age: 22,
      major: "Counseling",
      assetPath: "images/pics5.jpg",
    ),
    UserProfile(
      name: "Nina",
      age: 24,
      major: "Accountant",
      assetPath: "images/pics6.jpg",
    ),
    UserProfile(
      name: "Dina",
      age: 21,
      major: "Landscape",
      assetPath: "images/pics7.jpg",
    ),
    UserProfile(
      name: "Fathia",
      age: 19,
      major: "Pendidikan Islam",
      assetPath: "images/pics8.jpg",
    ),
    UserProfile(
      name: "Zahra",
      age: 23,
      major: "Syariah",
      assetPath: "images/pics9.jpg",
    ),
  ];
